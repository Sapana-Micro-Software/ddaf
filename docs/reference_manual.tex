...
\title{DDAF Reference Manual}
\subtitle{Data-Driven, Dynamic, Online, and Attention-Based Activation Functions}
...
\begin{itemize}
    ...
    \item \texttt{param_size}: Size of additional parameters (usually 0)
\end{itemize}
